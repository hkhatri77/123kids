...
var PostStory = Parse.Object.extend ({
	className: 'Post',
...
var myStory = new PostStory();
myStory.set('title', 'words words words');
myStory.set('story', 'We love words');

console.log(myStory);

// myStory.save().then(function(savedRecord){
	//your code here...
//});

//--------------------------------------
//Making Queries to your Database
//-----------------------------------------
var pquery = new Parse.Query(PostStory)
pquery.equalTo("title","words words words")
